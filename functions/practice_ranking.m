...
Practice_ranking_Indications = uicontrol(g, 'Style','text','String',sprintf('Each participant who has completed the game has been ranked in order of performance. To determine your rank, you will compete against previous participants whose scores have been pre-recorded.\n\nYou will start each tournament at rank %d out of %d. Your final rank will be averaged based on your performance on the %d tournaments.', starting_rank, ranking_length, blocks),'units', 'normalized', 'Position',[0.05,0.25,0.9,0.65],'Backgroundcolor', 'k', 'ForegroundColor','w', 'fontname', 'Arial', 'fontsize', 30, 'HorizontalAlignment', 'center');
...
Practice_ranking_Indications = uicontrol(g, 'Style','text','String',sprintf('Beware! Many players steal apples from their opponent to help increase their own chance of victory. Before each round, you will be asked how many apples, if any, you would like to take from your opponent.\n\nAt the end of the round, the final apple counts will be displayed without indicating if any were stolen. Note that the apples you take are not added to your own score, just removed from your opponent''s score.'),'units', 'normalized', 'Position',[0.05,0.25,0.9,0.65],'Backgroundcolor', 'k', 'ForegroundColor','w', 'fontname', 'Arial', 'fontsize', 30, 'HorizontalAlignment', 'center');
